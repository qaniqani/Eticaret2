        ...
        this
			...
			.each(function () {
			    ...
			    MultiFile.addToList = function (slave, slave_count, files) {
			        ...
			        var languages = $("#hfLanguages").val().split(",");
			        ...
			        $.each(files, function (i, file) {
			            ...
			            $.each(languages, function (i, language) {
			                $labelString += '<span class="MultiFile-title"><input type="text" name="FileName_' + language + '" id="FileName_' + language + '" class="form-control" placeholder="' + language + ' Name" /></span>' +
			                    '<span class="MultiFile-title"><textarea name="FileDescription_' + language + '" id="FileDescription_' + language + '" class="form-update" placeholder="' + language + ' Description" /></span>';
			            });
			            ...
			            label = $(
                                (
                                    '<div class="col-sm-2"><span class="MultiFile-label" title="' + t + '">' +
