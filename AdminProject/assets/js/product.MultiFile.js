                                    ...
                                    '<div class="col-md-3">' +
                                        '<div>' +
											'<span class="MultiFile-label" title="' + t + '">' +
												//'<span class="MultiFile-title"><input type="radio" name="showcase" ' + (i == 0 ? 'checked' : '') + ' /> Is Showcase?</span>' +
												//(MultiFile.preview || $(slave).is('.with-preview') ? p : '') +
                                                '<span class="MultiFileImg">' + (file.type.substr(0, 6) == 'image/' && (MultiFile.preview || $(slave).is('.with-preview')) ? p : '') + '</span>' +
                                                '<span class="MultiFile-title center-block" style="text-align:center;">' + n + '</span>' +
                                                '<span class="MultiFile-title center-block" style="text-align:center;"><input type="radio" class="productPictureShowcase" value="'+ i +'" name="showcase" ' + (i == 0 ? 'checked' : '') + ' /> Is Showcase?</span>' +
											'</span>' +
                                        '</div>' +
                                    '</div>'
										)
