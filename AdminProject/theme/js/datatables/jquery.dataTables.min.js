...
[a,null,a.jqXHR]);-1===h.inArray(!0,d)&&("parsererror"==c?K(a,0,"Geçersiz JSON",1):4===b.readyState&&K(a,0,"Ajax hatası",7));C(a,!1)}};a.oAjaxData=b;s(a,null,"preXhr",[a,b]);a.fnServerData?a.fnServerData.call(j,a.sAjaxSource,h.map(b,function(a,b){return{name:b,value:a}}),i,a):a.sAjaxSource||"string"===typeof g?a.jqXHR=h.ajax(h.extend(n,{url:g||a.sAjaxSource})):h.isFunction(g)?a.jqXHR=g.call(j,b,i,a):(a.jqXHR=h.ajax(h.extend(n,g)),g.data=f)}function nb(a){return a.bAjaxDataGet?(a.iDraw++,C(a,
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"İleri",sPrevious:"Geri"},sEmptyTable:"Tabloda geçerli kayıt yok",sInfo:"_START_ ile _END_ arası gösteriliyor. Toplam _TOTAL_ kayıt var.",sInfoEmpty:"Tabloda 0 kayıt var.",sInfoFiltered:"(En fazla _MAX_ kayıt filtrelenebilir.)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ kayıt göster",sLoadingRecords:"Yükleniyor...",sProcessing:"İşleniyor...",sSearch:"Arama:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Kayıt bulunamadı."},
